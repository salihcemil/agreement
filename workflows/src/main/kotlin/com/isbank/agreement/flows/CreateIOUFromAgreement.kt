...
object CreateIOUFromAgreement {
    ...
    class Initiator(val iouValue: Long,
                    ...
                    val externalRefId: UniqueIdentifier) : FlowLogic<SignedTransaction>() {
        /**
        ...
        override fun call(): SignedTransaction {
            ...
            val iouState = IOUState(IOUState.Status.CREATED, otherParty,serviceHub.myInfo.legalIdentities.first(), date, externalRefId.id, Amount(iouValue, Currency.getInstance(currencyCode)) )
    ...
    @InitiatedBy(CreateIOUFromAgreement.Initiator::class)
