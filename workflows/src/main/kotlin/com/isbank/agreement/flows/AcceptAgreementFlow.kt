...
object AcceptAgreementFlow {
    ...
    class Initiator(val agreementStateID: UniqueIdentifier) : FlowLogic<SignedTransaction>() {
        ...
        override fun call(): SignedTransaction {
            ...
            val outputAgreementState = inputAgreementState.state.data.withNewStatus(Status.ACCEPTED)
            ...
            /*
               create iou için gereken komut ve  output state oluşturuluyor
             */
            // Generate an unsigned transaction.
        ...
        override fun call(): SignedTransaction {
            val signTransactionFlow = object : SignTransactionFlow(otherPartySession) {
               ...
               //     "Amount is greater then " using (Agreement.) // TODO: Define valid amount
                    "The AgreementState should be set to ACCEPTED." using (Agreement.status == Status.ACCEPTED)
