        ...
        when (event) {
            ServiceLifecycleEvent.STATE_MACHINE_STARTED -> {
                ...
                val results = builder {
                    ...
                    val validUntilIndex = AgreementSchemaV1.PersistentAgreement::t_validUntil.greaterThan(Date())
                    ...
                    myAgreements.map { serviceHub.startFlow((ExpireAgreementFlow::Initiator)(it.state.data.linearId)) }
                }
