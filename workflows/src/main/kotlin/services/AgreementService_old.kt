...
/*
@CordaService
class AgreementService_old(private val serviceHub: AppServiceHub) : SingletonSerializeAsToken() {
    ...
    fun ExpireAgreements() {
        ...
        loggerFor<AgreementService_old>().info("Running test on thread($threadId).")
        ...
        loggerFor<AgreementService_old>().info("Builder result($results).")
    }
